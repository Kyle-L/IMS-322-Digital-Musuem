...
function Page() {
  return (
    <SculptureLayout title="Neptune" model={<Model />} modelOffset={[0, 4, 0]}>
      <h1>Neptune</h1>
      <SculptureModal name="Neptune" artist="Antoine Coysevox" date="1703 - 1705 (signing)" held="Louvre Museum in Paris, France" heldLink="https://collections.louvre.fr/en/" moreInfo='https://collections.louvre.fr/en/ark:/53355/cl010094811' origin="Marlay, France" />
      <p>
