...
function Sculptures() {
  return (
    <BasePageTemplate title={'Sculptures'}>
      <div className="row col"><h1>Welcome!</h1></div>
      <div className="row">
        <div className="col">
          <p>
            ...
            The digital museum solves that problem by allowing you to view the sculpture in 3D. While a picture speaks a 1000 words, a 3d models speaks quite a few more in this case! Take a moment to explore some of the exhibits!
          </p>
        </div>
      </div>
      <hr />
      <div className="row col"><h1>Explore Sculptures!</h1></div>
      <div className='row'>
        <div className='col'>
